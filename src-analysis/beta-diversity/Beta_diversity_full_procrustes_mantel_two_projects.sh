...
do
    ...
    echo "Performing analysis for project: $project"
  ...
  qiime diversity procrustes-analysis \
    --i-reference "${path}/src-analysis/diversity-analysis/beta-diversity/${project}/diversity-results-non-filtered/bray_curtis_filtered_pcoa.qza" \
  ...
  qiime emperor procrustes-plot \
    --i-reference-pcoa "${path}/src-analysis/diversity-analysis/beta-diversity/${project}/diversity-results-non-filtered/bray_curtis_filtered_pcoa.qza" \
  ...
  # Perform Procrustes analysis between conditions within the project
  qiime diversity procrustes-analysis \
    --i-reference "${path}/src-analysis/diversity-analysis/beta-diversity/${project}/diversity-results-non-filtered/jaccard_filtered_pcoa.qza" \
  ...
  # Visualize the Procrustes results
  qiime emperor procrustes-plot \
    --i-reference-pcoa "${path}/src-analysis/diversity-analysis/beta-diversity/${project}/diversity-results-non-filtered/jaccard_filtered_pcoa.qza" \
  ...
  qiime diversity mantel \
    --i-dm1 "${path}/src-analysis/diversity-analysis/beta-diversity/${project}/diversity-results-non-filtered/bray_curtis_filtered_distance_matrix.qza" \
  ...
  # 2.2 Jaccard Index
  qiime diversity mantel \
    --i-dm1 "${path}/src-analysis/diversity-analysis/beta-diversity/${project}/diversity-results-non-filtered/jaccard_filtered_distance_matrix.qza" \
    ...
    # Continue to the next iteration after performing the analysis
    continue
  fi

  # If the project is not PRJEB35665 or PRJNA756382, skip to the next project
